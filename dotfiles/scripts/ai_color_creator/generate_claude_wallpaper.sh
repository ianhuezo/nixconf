...
TERM=dumb claude -p --add-dir "$WALLPAPER_DIR" --settings "$SETTINGS_JSON" --print --output-format json "Read $WALLPAPER_PATH $(cat ~/.config/custom_scripts/ai_color_creator/prompt.md)" </dev/null >"$STDOUT_FILE" 2>"$STDERR_FILE" &
